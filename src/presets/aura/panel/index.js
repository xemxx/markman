export default {
  ...
  transition: {
    ...
    enterActiveClass:
      'overflow-hidden transition-[max-height] duration-1000 ease-&lsqb;cubic-bezier(0.42,0,0.58,1)&lsqb;',
    enterToClass: 'max-h-[1000px]',
    leaveFromClass: 'max-h-[1000px]',
    leaveActiveClass:
      'overflow-hidden transition-[max-height] duration-&lsqb;450ms] ease-[cubic-bezier(0,1,0,1)&lsqb;',
